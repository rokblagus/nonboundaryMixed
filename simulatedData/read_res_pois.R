...
pdf("pois/figs/supp_pois_boundary.pdf",height=10,width=10)
...
pdf("pois/figs/supp_pois_beta5.pdf",height=10,width=10)
...
pdf("pois/figs/main_pois_boundary.pdf",height=6,width=12)
p0
dev.off()
